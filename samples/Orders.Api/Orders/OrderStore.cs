...
/// <summary>
/// The sample's whole persistence layer.
/// </summary>
public sealed class OrderStore
{
    ...
    // Find and Save as two calls would drop a concurrent write, so the update only lands while the
    // order still matches what this call read.
