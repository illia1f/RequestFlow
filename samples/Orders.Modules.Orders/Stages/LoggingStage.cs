...
namespace Orders.Modules.Orders.Stages;

/// <summary>
/// Times every request, including void requests.
/// </summary>
internal sealed class LoggingStage<TRequest, TResponse>(ILogger<LoggingStage<TRequest, TResponse>> logger)
