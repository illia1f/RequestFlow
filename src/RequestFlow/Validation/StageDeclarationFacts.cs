...
/// of the call that registered it, and the handler contract <c>WhereHandlerImplements</c> narrowed
/// it to.
/// </summary>
/// <remarks>
...
/// call. The freeze builds this from the declarations themselves and hands it to the rules that
/// would otherwise guess.
/// <para>
/// One stage type registered twice already fails <c>RF0103</c>, so the first call answers for it.
/// <see cref="None"/> stands for a model built by hand, where every answer falls back to the
/// contract.
/// </para>
/// </remarks>
